...
Please enter the **.oraid/config/gentx/** directory. You'll see a json file which contains your validator information. Please copy its content and send us through the email mainnet@orai.io with title: **gentx mainnet your-moniker**
